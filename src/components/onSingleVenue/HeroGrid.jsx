function HeroGrid({ venueGallery }) {
  return (
    <section className="mt-28 mb-14 relative">
      ...
      <div
        className={`relative overflow-hidden h-auto shadow-md rounded-lg ${
          venueGallery.length >= 1 ? 'grid grid-cols-1 lg:grid-cols-2' : ''
        }`}
      >
        {/* <div className="flex flex-col gap-4 p-4 bg-white shadow-md rounded-lg "> */}
        <div className="flex flex-col gap-4 p-4 h-[400px] md:h-[500px] max-h-[800px]">
          <img
            src={venueGallery[0]?.url}
            alt={venueGallery[0]?.alt || 'img'}
            className="rounded-lg w-full h-auto object-cover overflow-hidden "
          ...
          />
          <div
            className={`flex flex-col absolute bottom-0 left-0 right-0 bg-white p-4 rounded-lg shadow-md ${
        ...
        <div className=" flex-row gap-4 p-4 bg-white shadow-md rounded-lg justify-around relative hidden sm:flex">
